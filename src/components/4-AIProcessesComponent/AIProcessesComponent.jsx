              ...
              <div className="cards__card">
                <div className="cards__content">
                  <img
                    ...
                    src="src/assets/images/How_AI_Learns.jpg"
                    alt="diagram of AI relations"
                  />
                  <div className="cards__description">
                    ...
                    <div className="cards__body">
                      ...
                      <p className="cards__details">
                        <strong>Prediction:</strong> In healthcare, AI can
                        predict patient outcomes by analyzing historical medical
                        data.
                      </p>
                      <p className="cards__details">
                        <strong>Creativity:</strong> In art and writing, AI can
                        generate realistic images or coherent text by
                        understanding the structure of existing works. AI
                        doesn’t just mimic human decision-making—it improves as
                        it encounters more data, continually refining its
                ...
                <div className="cards__content">
                  <img
                    className="cards__img"
                    src="src/assets/images/privacy.jpg"
                    alt="image with data secure logos"
                  />
                  <div className="cards__description">
                    ...
                    <div className="cards__body">
                      ...
                      <p className="cards__details">
                        Reputable organizations follow strict guidelines to
                        ensure data is used responsibly and transparently. This
                        means your personal data remains confidential, even as
                        AI systems work to enhance your experience.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="cards__content">
                  <img
                    className="cards__img"
                    src="src/assets/images/Real_time_data.jpg"
                    alt="image with data secure logos"
                  />
                  <div className="cards__description">

...
export default function CourseFeedbackComponent() {
    ...
    const validateForm = () => {
        ...
        if (!responses.questionThree.trim())
            newErrors.questionThree =
                "Please answer what surprised you about AI!";
                    ...
                    >
                        <div className="survey">
                            ...
                            <h3 className="survey__subtitle">
                                Your feedback helps us improve and create more
                            ...
                            >
                                <div className="survey-form__rateExperience">
                                    <p className="survey-form__label">
                                        Rate your overall experience of the
                                        course
                                    </p>
                                    {Array.from(
                                        { length: 10 },
                                ...
                                <div className="survey-form__rateNavigate">
                                    <p className="survey-form__label">
                                        Rate your experience with navigating the
                                        course pages
                                    </p>
                                    {Array.from(
                                        { length: 10 },
                                ...
                                <div className="survey-form__questionThree">
                                    ...
                                    >
                                        What did you learn about AI that
                                        surprised you?
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="survey-form__questionFour">
                                    <label
                                        ...
                                        className="survey-form__label"
                                    >
                                        What features of AI do you want to
                                        explore further?
                                    </label>
                                    <input
                                        type="text"

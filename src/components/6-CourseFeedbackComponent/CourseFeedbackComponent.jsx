                        ...
                        <form className="survey-form" onSubmit={handleSubmit}>
                                ...
                                {Array.from({ length: 10 }, (_, i) => i + 1).map((num) => (
                                    <label key={num} for={`question-one-${num}`}>
                                        ...
                                        <input
                                            ...
                                            id={`question-one-${num}`}
                                            value={num}
                                            onChange={(e) => handleRatingChange("questionOne", e.target.value)}
                                            required
                                        />
                                    </label>
                                ))}
                                ...
                                {Array.from({ length: 10 }, (_, i) => i + 1).map((num) => (
                                    <label key={num} for={`question-two-${num}`}>
                                        ...
                                        <input
                                            ...
                                            id={`question-two-${num}`}
                                            value={num}
                                            onChange={(e) => handleRatingChange("questionTwo", e.target.value)}
                                            required
                                        />
                                    </label>
                                ))}
                                {errors.questionTwo && <p className="error">{errors.questionTwo}</p>}
                            </div>
                            <div className="survey-form__questionThree">
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleResponseChange("questionThree", e.target.value)}
                                />
                                {errors.questionThree && <p className="error">{errors.questionThree}</p>}
                            </div>
                            <div className="survey-form__questionFour">
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleResponseChange("questionFour", e.target.value)}
                                />
                                {errors.questionFour && <p className="error">{errors.questionFour}</p>}
                            </div>
                            <div className="survey-form__questionFive">
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleResponseChange("questionFive", e.target.value)}
                                />
                                {errors.questionFive && <p className="error">{errors.questionFive}</p>}
                            </div>
